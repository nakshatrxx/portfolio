...
import { ArrowDown, Sparkles, Terminal, Layers, Flame, MapPin } from 'lucide-react';
    ...
    <section className="relative min-h-[92vh] flex flex-col justify-center items-center px-4 sm:px-6 pt-24 pb-12 overflow-hidden court-bg">
      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center text-center z-10">
        ...
        >
          ...
          <span className="text-white font-medium">Knowledge Synonyms</span>
          <span className="text-zinc-600">|</span>
          <span className="flex items-center gap-1 text-zinc-400">
            <MapPin className="w-3 h-3 text-curry-gold" /> Noida, IN
          </span>
        </motion.div>
        ...
        >
          ...
          {/* Interactive Basketball Trigger */}
          <button
            onClick={() => {
              sounds.playBounce();
        ...
        {/* Quick Highlights / Editorial Ticker */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.6 }}
          className="mt-14 pt-8 border-t border-white/10 w-full max-w-4xl grid grid-cols-2 md:grid-cols-4 gap-4 text-left"
        >
          <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
            <div className="text-[11px] font-mono text-zinc-500 uppercase">Core Focus</div>
            <div className="text-sm font-semibold text-zinc-200 mt-0.5 font-display">LLMs & RAG Engines</div>
          </div>
          <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
            <div className="text-[11px] font-mono text-zinc-500 uppercase">Flagship Product</div>
            <div className="text-sm font-semibold text-curry-gold mt-0.5 font-display">SVASU E-Learning</div>
          </div>
          <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
            <div className="text-[11px] font-mono text-zinc-500 uppercase">Court Persona</div>
            <div className="text-sm font-semibold text-zinc-200 mt-0.5 font-display">Curry #30 Range</div>
          </div>
          <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
            <div className="text-[11px] font-mono text-zinc-500 uppercase">Availability</div>
            <div className="text-sm font-semibold text-emerald-400 mt-0.5 font-display">Engineering & Ship</div>
          </div>
        </motion.div>
